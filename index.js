...
console.log(createMenuItem('pad thai', 3, 'Lunch'));
console.log(createMenuItem('salmon fillet', 5, 'Dinner'));
console.log(createMenuItem('apple pie', 10, 'Dessert'));
...
function addReview(listOfReviews, name, rating, feedback) {
  listOfReviews.push({
...
console.log(addReview([null, 4], 'Kris', 1, 'Bad pizza'))
